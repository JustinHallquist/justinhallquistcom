export default function SectionTabs({ sections, activeSection, handleSetActiveSection }: { sections: Array<string>, activeSection: string, handleSetActiveSection: Function }) {
  return <div className="flex">
    {sections?.length ? sections.map((section: string, idx: number) =>
